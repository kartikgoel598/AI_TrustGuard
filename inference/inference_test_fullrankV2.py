...
MODEL_PATH = os.path.join(CURRENT_DIR, "..", "models", "full-rank", "final_V2")

DATA_DIR = os.path.join(CURRENT_DIR, "..", "dataset",'benignin_dataset')
DATA_FILE_NAME = 'val_data.csv'
FULL_DATA_PATH = os.path.join(DATA_DIR, DATA_FILE_NAME)
...
raw_dataset = load_dataset('csv', data_files=FULL_DATA_PATH , split = 'train')
print(f'total rows in the raw dataset is : {len(raw_dataset)}')

NUM_SAMPLES = 5
random_sample = random.sample(range(len(raw_dataset)), NUM_SAMPLES)
